...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/region", controller.GetRegion)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/rate-limit-usage", controller.GetSelfRateLimitUsage)
		...
		ticketRoute.Use(middleware.UserAuth())
		{
			...
			ticketRoute.POST("/:id/reply", controller.ReplyUserTicket)
		}
		...
		taskRoute := apiRouter.Group("/task")
		{
			...
			taskRoute.POST("/sync", middleware.AdminAuth(), controller.SyncTask)
			taskRoute.POST("/sync-all", middleware.AdminAuth(), controller.SyncAllTasks)
		}
